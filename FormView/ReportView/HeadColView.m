...
@interface HeadColView() <UITableViewDelegate, UITableViewDataSource>

@property (strong, nonatomic) UITableView *tableView;

@end

@implementation HeadColView
...
{
    if (_delegate && [_delegate respondsToSelector:@selector(headColDidScroll:)]) {
        [_delegate headColDidScroll:scrollView.contentOffset];
    }
}
@end
